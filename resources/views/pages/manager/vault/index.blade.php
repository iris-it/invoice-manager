                            ...
                            @foreach($vaults as $vault)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{action('Manager\VaultController@edit', $vault->id)}}" class="btn btn-flat btn-info" type="button" data-toggle="tooltip" title="{{trans('vault.edit-action')}}">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="{{action('Manager\VaultController@destroy',['id' => $vault->id])}}" class="btn btn-flat btn-danger" data-method="DELETE" data-toggle="tooltip" title="{{trans('vault.delete-action')}}" data-token="{{csrf_token()}}" data-confirm="{{trans('vault.delete-action-warning')}}">
